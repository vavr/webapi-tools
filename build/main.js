...
var pu = require('../utils/promise');
var API_KEY = "notspecified";
...
function getTwoGisFilial(text) {
    ...
    if (!isNaN(filialId) && isLikeFilialId(filialId)) {
        return pu.promiseMap(branchGet(filialId.toString()), function (filial) {
...
function getTwoGisRubric(text) {
    ...
    if (!isNaN(rubricId) && isLikeRubricId(rubricId)) {
        return pu.promiseMap(rubricGet(rubricId.toString()), function (rubric) {
...
module.exports = getTwoGisObject;
},{"../utils/promise":6}],3:[function(require,module,exports){
/// <reference path="../../typings/es6-promise/es6-promise.d.ts" />
...
module.exports = getDetectedUnixtime;
},{"moment":1}],4:[function(require,module,exports){
/// <reference path="../typings/es6-promise/es6-promise.d.ts" />
var getDetectedUnixtime = require('./handlers/unixtime');
var getTwoGisObject = require('./handlers/twogis');
var pu = require('./utils/promise');
var TipManager = require('./ui/tipManager');
var handlers = [
    getDetectedUnixtime,
    getTwoGisObject
];
var tipManager = new TipManager("__chrome_extension_webapi_tools_tip");
function applyHandlers(text) {
    return pu.getResolvedPromises(handlers.map(function (_) { return _(text); }));
}
...
},{"./handlers/twogis":2,"./handlers/unixtime":3,"./ui/tipManager":5,"./utils/promise":6}],5:[function(require,module,exports){
...
exports.getResolvedPromises = getResolvedPromises;
...
exports.positiveRace = positiveRace;
},{}]},{},[4]);
